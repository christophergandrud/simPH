#' Transform the simulation object to include only the min, max, and the lower 
#' and upper bounds of the middle 50 percent
#'
#' \code{MinMaxLines} is an internal function to transform the simulation 
#' object to include only the min, max, and the lower and upper bounds of the 
#' middle 50 percent.
#'
#' @param df the data frame created by the simGG method from a simulation class 
#' object.
